...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _DisplayContainer = __webpack_require__(160);
	  ...
	  _createClass(App, [{
	    ...
	    value: function handleSubmit(event) {
	      ...
	      fetch('http://api.giphy.com/v1/gifs/search?q=' + this.state.term + '&limit=24&api_key=dc6zaTOxFJmzC').then(function (response) {
	        ...
	        _this2.setState({ attributes: responseData.data });
	      });
	    }
	  }, {
	    key: 'render',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _DisplayTile = __webpack_require__(161);

	var _DisplayTile2 = _interopRequireDefault(_DisplayTile);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var DisplayContainer = function DisplayContainer(props) {
	  var attributes = props.attributes.map(function (attribute) {
	    return _react2.default.createElement(_DisplayTile2.default, {
	      key: attribute.id,
	      id: attribute.id,
